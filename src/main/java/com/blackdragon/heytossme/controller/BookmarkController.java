...
public class BookmarkController {
    ...
    @PostMapping
    public ResponseEntity<ResponseForm> registerBookmarks(HttpServletRequest request,
    ...
    public ResponseEntity<ResponseForm> deleteBookmarks(HttpServletRequest request,
